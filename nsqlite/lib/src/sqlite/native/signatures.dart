...
typedef sqlite3_column_int64_native_t = Int64 Function(
    Pointer<Statement> statement, Int64 columnIndex);
...
typedef sqlite3_bind_parameter_index_native = Int32 Function(
    Pointer<Statement> statement, Pointer<CBlob>);

typedef sqlite3_bind_parameter_name_native = Pointer<CBlob> Function(
    Pointer<Statement> statement, Int32 value);
...
typedef sqlite3_bind_zeroblob_native = Int32 Function(
    Pointer<Statement> statement, Int32 columnIndex, Int32 length);
