...
import 'package:nsqlite/src/ffi/types.dart';
import 'package:nsqlite/src/load_library.dart';
...
class _SQLiteBindings {
  ...
  int Function(
      ...
      Pointer<Pointer<CBlob>> errorMsgOut) sqlite3_exec;
  ...
  int Function(Pointer<Statement> statement, int paramIndex, int length)
      sqlite3_bind_zeroblob;
  int Function(Pointer<Statement> statement, int paramIndex) sqlite3_bind_null;

  int Function(Pointer<Statement> statement, Pointer<CBlob> value)
      sqlite3_bind_parameter_index;
  Pointer<CBlob> Function(Pointer<Statement> statement, int paramIndex)
  ...
  _SQLiteBindings() {
    ...
    sqlite3_bind_blob = sqlite
        ...
        .asFunction();
    sqlite3_bind_zeroblob = sqlite
        .lookup<NativeFunction<sqlite3_bind_zeroblob_native>>(
            'sqlite3_bind_zeroblob')
        .asFunction();
    sqlite3_bind_null = sqlite
        .lookup<NativeFunction<sqlite3_bind_null_native>>('sqlite3_bind_null')
        .asFunction();
    sqlite3_bind_parameter_index = sqlite
        .lookup<NativeFunction<sqlite3_bind_parameter_index_native>>(
            'sqlite3_bind_parameter_index')
        .asFunction();
    sqlite3_bind_parameter_name = sqlite
        .lookup<NativeFunction<sqlite3_bind_parameter_name_native>>(
            'sqlite3_bind_parameter_name')
        .asFunction();
